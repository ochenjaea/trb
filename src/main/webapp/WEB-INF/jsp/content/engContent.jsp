	...
	<div data-role="page" data-theme="a">
		...
		<div data-role="content">
			...
			<div style="float:left;">
				<div data-role="controlgroup" data-type="horizontal">
					...
					<a href="#" onclick ="engContent('${pre_osis}',${pre_chap})" data-role="button" data-icon="arrow-l" data-iconpos="left" data-inline="true">이전</a>
					</c:if>
				
					<c:if test= "${next_osis != '0'}">
					<a href="#" onclick ="engContent('${next_osis}',${next_chap})"  data-role="button" data-icon="arrow-r" data-iconpos="right" data-inline="true">다음</a>
					</c:if>
				</div>
			</div>
		</div>
		<div data-role="popup" id="menu" data-position="right" data-display="overlay">
				<ul data-role="listview" data-theme="d" data-icon="false">
				    ...
				    <li data-icon="plus" data-mini="true"><a href="#" onclick="engBigContent('${now_osis}',${now_chap})">Expand</a></li>
				    <li data-icon="gear" data-mini="true"><a href="#" onclick="korContent('${now_osis}',${now_chap})">KOR</a></li>
				    <li data-icon="star" data-mini="true"><a href="#" onclick="kengContent('${now_osis}',${now_chap})">KOR/ENG</a></li>
				    <li data-icon="search" data-mini="true"><a href="#" onclick="word()">Search</a></li>
				    <c:if test= "${pre_osis != '0'}">
					<li data-icon="arrow-l" data-mini="true"><a href="#" onclick ="engContent('${pre_osis}',${pre_chap})">Prev</a></li>
					</c:if>
				
					<c:if test= "${next_osis != '0'}">
					<li data-icon="arrow-r" data-mini="true"><a href="#" onclick ="engContent('${next_osis}',${next_chap})">Next</a></li>
					</c:if>
				</ul>
			</div>
	</div>
